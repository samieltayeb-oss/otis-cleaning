...
| **Phase 2** | **Weeks 2–4 (Days 8–30)** | • **Lock In Contracts**: Present 6-Month or 10-Month Preferred Commercial Agreements to existing uncontracted clients ($6,100 MRR base).<br>• **Article 14 Decree Shield**: Issue bilingual CPEEP ($22.59/h) + CNESST compliance dossier to protect building managers from joint liability.<br>• **Google Review Sprint**: Automated SMS review requests to reach 25–50 reviews. | **\$6,100 MRR 100% contracted** + Top-3 Google Maps ranking. |
